...
import { MoviesCarousel } from "containers";
  ...
  return (
    <>
      <section
        ...
        className={c(
          styles["pdp-section"],
          styles[`font-${searchParams.get("category")}`]
        )}
        role="group"
                  ...
                  <div className={styles["product-description"]}>
                    ...
                    {movie.production_companies?.length > 0 && (
                      <>
                        ...
                        <span>
                          {getValues(movie.production_companies, ", ")}
                        </span>
                      </>
                    )}
                  </div>
      ...
      {wishlistItems.length > 0 && (
        <MoviesCarousel title="Your Wishlist" selectedMovies={wishlistItems} />
      )}
    </>
  );
};
